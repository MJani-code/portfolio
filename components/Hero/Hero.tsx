        ...
        <div className="bg-gray-900">
            ...
            <section className="mt-24 mx-auto max-w-screen-xl pb-12 px-4 items-center lg:flex md:px-8">
                <div className="space-y-4 flex-1 sm:text-center lg:text-left">
                        <span className="text-indigo-400"> DigitalForge</span>
                    <h1 className="text-white font-bold text-4xl xl:text-5xl">
                    Álmodj nagyot, mi megvalósítjuk!
                    </h1>
                    <p className="text-gray-300 max-w-xl leading-relaxed sm:mx-auto lg:ml-0">
                    Szakértők vagyunk a webfejlesztés, API-k, webshopok és devOps terén. Átfogó tudásunkkal és tapasztalatunkkal segítünk a digitális projektek sikeres megvalósításában, munkafolyamatok optimalizálásában!
                    </p>
